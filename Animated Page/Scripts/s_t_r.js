...
start = async function(){
    ...
    while (lst.length > 0){
        ...
        // var (process_time-index) = process_time - 1;
        ...
        for (let index = 1; index < process_time+1; index++) {
            ...
            if (lst.length > 0) {
                if(difference < lst[0].time){
                    ...
                    document.getElementById("executed").innerHTML = '<div class="execution-box box-up-row"><div id="moving-box2" class="process green"><p>' + process_name + "</p><p>" + difference + 'ms</p></div>';
                    ...
                    console.log("Updating: " + process_obj.id + " with " + difference);
                    var updated_obj = {id:(process_obj.id), time:difference};
...
function myMoveBack(timer=1, down=false) {
    var id = null;
    var elem = document.getElementById("moving-box2");
    var pos_left = 0;
    var pos_down = 0;
...
window.onload = function() {
    console.log('window - onload {Shortest Time Remaining}');
